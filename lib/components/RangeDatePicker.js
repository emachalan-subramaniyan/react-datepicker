...
var RangeDatePicker = /** @class */ (function (_super) {
    ...
    function RangeDatePicker(props) {
        ...
        _this.timeClick = function (data) {
            _this.setState(__assign({}, _this.state, { tabValue: data === 'date' ? TabValue.DATE : TabValue.TIME, show: !_this.state.show }));
        };
        _this.renderTime = function () {
            var date = _this.state.date || dayjs();
            return (React.createElement(TimeContainer_1.default, { hour: date.hour(), minute: date.minute(), onChange: _this.handleTimeChange, allowedTime: _this.state.isAllowedTime }));
        };
