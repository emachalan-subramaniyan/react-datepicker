...
var CalendarHead = function (_a) {
    ...
    return (React.createElement("div", { className: "calendar__head custom-header" },
        ...
        React.createElement("h2", { className: "calendar__head--title head-textstyle", onClick: onTitleClick }, title),
