...
var RangePickerInput = /** @class */ (function (_super) {
    ...
    function RangePickerInput() {
        ...
        _this.renderPickerInput = function (fieldType, value, placeholder) {
            ...
            return (React.createElement(PickerInput_1.default, { value: value ? value : null, readOnly: readOnly, disabled: disabled, clear: clear, className: "range", onClear: _this.handleClear(fieldType), onClick: _this.handleClick(fieldType), onChange: _this.handleChange(fieldType), onBlur: _this.handleBlur(fieldType), placeholder: placeholder }));
        };
        return _this;
    }
    RangePickerInput.prototype.render = function () {
        var _a = this.props, ontimeClick = _a.ontimeClick, allowedTimes = _a.allowedTimes;
        return (React.createElement("div", { className: "range-picker-input custom-tab" },
            ...
            React.createElement("div", { className: "custom-icon" },
                React.createElement("span", { onClick: function () { return ontimeClick('date'); } },
                    React.createElement(SVGIcon_1.default, { id: "calendar" })),
                allowedTimes && React.createElement("span", { onClick: function () { return ontimeClick('time'); } },
                    React.createElement(SVGIcon_1.default, { id: "time" }))),
