...
var Calendar = /** @class */ (function (_super) {
    ...
    Calendar.prototype.render = function () {
        var _this = this;
        var _a = this.props, showMonthCnt = _a.showMonthCnt, todayDate = _a.todayDate, allowedTime = _a.allowedTime, allowedDays = _a.allowedDays;
        ...
        return (React.createElement("div", { className: "calendar" },
            React.createElement("div", { className: "calendar__list" },
                ArrayUtil_1.range(showMonthCnt).map(function (idx) { return (React.createElement("div", { className: "calendar__item", key: idx },
                    ...
                    React.createElement(CalendarContainer_1.default, __assign({}, _this.props, { base: _this.state.base, current: dayjs(base).add(idx, 'month'), prevIcon: idx === 0, nextIcon: idx === showMonthCnt - 1, setBase: _this.setBase, todaydate: todayDate, allowedTime: allowedTime, allowedDays: allowedDays })))); }),
                React.createElement("div", { className: "calendar__list calendar-week" },
