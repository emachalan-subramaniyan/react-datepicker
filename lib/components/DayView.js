...
var DayView = /** @class */ (function (_super) {
    ...
    function DayView() {
        ...
        _this.firstcondition = function (data) { return (data.shift(), data.pop()); };
        _this.lastcondition = function (data) { return data; };
        return _this;
    }
    DayView.prototype.render = function () {
        var _this = this;
        var _a = this.props, current = _a.current, locale = _a.locale, allowedDays = _a.allowedDays;
        ...
        return (React.createElement(TableMatrixView_1.default, { headers: weekdays, matrix: dayMatrix, allowedDays: allowedDays, cell: function (date, key) { return (React.createElement(TableCell_1.default, { className: _this.getDayClass(date), subText: _this.getCustomText(date), onClick: _this.handleClick, onMouseOver: _this.handleMouseOver, text: date, key: key })); } }));
    };
