...
var RangeDatePicker = /** @class */ (function (_super) {
    ...
    function RangeDatePicker(props) {
        ...
        _this.handleTimeChange = function (hour, minute) {
            _this.setState(__assign({}, _this.state, { startTime: hour, endTime: minute }));
        ...
        _this.renderTime = function () {
            ...
            return (React.createElement(TimeContainer_1.default, { hour: date.hour(), minute: date.minute(), onChange: _this.handleTimeChange, allowedTime: _this.props.allowedTimes }));
        };
