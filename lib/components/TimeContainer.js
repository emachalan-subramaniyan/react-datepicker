...
var TimeContainer = /** @class */ (function (_super) {
    ...
    function TimeContainer() {
        ...
        _this.handleSession = function (data, item) { return function () {
            var _a;
            var _b = _this.state, starthour = _b.starthour, startminute = _b.startminute, startsessions = _b.startsessions, endhour = _b.endhour, endminute = _b.endminute, endsessions = _b.endsessions;
