...
var RangePickerInput = /** @class */ (function (_super) {
    ...
    function RangePickerInput() {
        ...
        _this.renderPickerInput = function (fieldType, value, placeholder) {
            ...
            return (React.createElement(PickerInput_1.default, { value: value ? value : '', readOnly: readOnly, disabled: disabled, clear: clear, className: "range", onClear: _this.handleClear(fieldType), onClick: _this.handleClick(fieldType), onChange: _this.handleChange(fieldType), onBlur: _this.handleBlur(fieldType), placeholder: placeholder }));
        };
        return _this;
    }
