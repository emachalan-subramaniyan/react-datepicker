...
var Picker = /** @class */ (function (_super) {
    ...
    Picker.prototype.render = function () {
        var _this = this;
        var _a = this.props, portal = _a.portal, className = _a.className, renderTrigger = _a.renderTrigger, renderContents = _a.renderContents, allowedTime = _a.allowedTime, allowedDays = _a.allowedDays;
        ...
        return (React.createElement("div", null,
            React.createElement("div", null,
                React.createElement("label", null, "Custom Options"),
                React.createElement("div", null,
                    React.createElement("label", null,
                        React.createElement("input", { type: "checkbox", checked: allowedDays, onChange: function () { return _this.props.onallowedDays(); } }),
                        "Allowed Days (ex: M-F)")),
                React.createElement("div", null,
                    React.createElement("label", null,
                        React.createElement("input", { type: "checkbox", checked: allowedTime, onChange: function () { return _this.props.onallowedTime(); } }),
