...
var DatePicker = /** @class */ (function (_super) {
    ...
    function DatePicker(props) {
        ...
        _this.handleDateChange = function (date) {
            ...
            _this.setState(__assign(__assign({}, _this.state), { date: date, inputValue: value, selected: [date] }));
        };
        _this.handleTimeChange = function (hour, minute) {
            ...
            _this.setState(__assign(__assign({}, _this.state), { date: date,
                selected: selected,
        ...
        _this.handleInputBlur = function (e) {
            ...
            _this.setState(__assign(__assign({}, _this.state), { date: updateDate, inputValue: dayjs(updateDate).format(_this.getDateFormat()) }));
        };
