...
var TableMatrixView = function (_a) {
    ...
    return (React.createElement("table", { className: classNames('calendar__body--table', className) },
        ...
        React.createElement("tbody", null, matrix.map(function (row, i) { return (allowedDays && (row.shift(),
            row.pop()),
            React.createElement("tr", { key: i }, row.map(function (v, j) { return cell(v, i * matrix[i].length + j); }))); }))));
};
