...
var RangeDatePicker = /** @class */ (function (_super) {
    ...
    function RangeDatePicker(props) {
        ...
        _this.ontodayclick = function () {
            ...
            _this.valueChanged(allowedDays && (curr.getDay() === 0 || curr.getDay() === 6) ? null : new Date().toLocaleDateString('en-CA'), allowedDays && (curr.getDay() === 0 || curr.getDay() === 6) ? null : new Date().toLocaleDateString('en-CA'), startTime, endTime);
        };
        _this.yesterdayClick = function () {
            ...
            _this.valueChanged(allowedDays && (yesterday.getDay() === 0 || yesterday.getDay() === 6) ? ' ' : yesterday.toLocaleDateString('en-CA'), allowedDays && (yesterday.getDay() === 0 || yesterday.getDay() === 6) ? ' ' : yesterday.toLocaleDateString('en-CA'), startTime, endTime);
        };
